...
public class MEBiomesData {
    ...
    public static void loadBiomes() {
        ...
        addBiome(new Color(200, 209, 255), new MEBiome(39, MEBiomeKeys.BLUE_MOUNTAINS, ModBlockSets.BLUE_ROCK.base(), ModBlockSets.BLUE_ROCK.base(), Blocks.STONE, Blocks.STONE));
        ...
        addBiome(new Color(60, 42, 42), new MEBiome(5, MEBiomeKeys.MORDOR, ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base()));
        addBiome(new Color(36, 31, 31), new MEBiome(37, MEBiomeKeys.MORDOR_MOUNTAINS, ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base(), ModBlockSets.ASHEN_ROCK.base()));
