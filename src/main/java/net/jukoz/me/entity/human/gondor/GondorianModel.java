...
public class GondorianModel<T extends MobEntity>
        extends BipedEntityModel<T> {
    public GondorianModel(ModelPart root) {
        super(root);
    }
    ...
    public void setAngles(T mobEntity, float f, float g, float h, float i, float j) {
        ...
        GondorianEntity.State state = ((GondorianEntity)mobEntity).getState();

        if(state == GondorianEntity.State.ATTACKING) {
            // Walk added
